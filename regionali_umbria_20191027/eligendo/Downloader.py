...
class Downloader:
	...
	def calcola_enti_pervenuti(self, nome_cartella):
		...
		list_ultimi_comuni_pervenuti = [(cod_i['cod_com'], cod_i['cod_prov']) for cod_i in list_ultimi_comuni_pervenuti]
	...
	def costruisci_item_url_scrutini(self, list_codici_ente):
		return [
			[
				...
				[['Referer', 'https://elezioni.interno.gov.it/regionali/scrutini/20191027/scrutiniRI{}'.format(codice_ente)]]
			] 
